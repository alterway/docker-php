...
- Apache/2.4 - PHP/8.1 (docker tags: `8.1-apache`) - `docker pull alterway/php:8.1-apache`
...
- Apache/2.4 - PHP/7.3 (docker tags: `7.3-apache`) - `docker pull alterway/php:7.3-apache` [DEPRECATED]
